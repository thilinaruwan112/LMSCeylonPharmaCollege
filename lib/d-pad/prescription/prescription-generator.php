...
$prescriptionName = $GeneratedPrescription['PrescriptionName'];
$prescriptionStatus = 'Active';
$presName = $GeneratedPrescription['PrescriptionName'];
$presDate = $GeneratedPrescription['PrescriptionDate'];
$presAge = $GeneratedPrescription['PatientAge'];
$presMethod = $GeneratedPrescription['PrescriptionMethod'];
...
<div class="row">
    <div class="col-md-12">
        <h3 class="mb-2 pb-2 border-bottom card-title fw-bold">Generated Prescription</h3>
        <form id="prescriptionForm" method="post">
            ...
            <div class="row g-3 mt-2">
                ...
                <div class="col-12 text-end">
                    <button onclick="GeneratePrescription()" class="btn btn-purple" type="button">
                        <i class="fa-solid fa-wand-magic-sparkles"></i> Re-Generate</button>
                    <button class="btn btn-dark" type="button" onclick="savePrescription('<?= $prescriptionId ?>')"><i class="fa-solid fa-floppy-disk"></i> Save</button>
                </div>
            </div>
