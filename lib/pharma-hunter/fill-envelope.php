...
$correctAnswer = HunterGetSavedAnswersByCover($link, $prescriptionID, $coverID);
...
if ($UserLevel != "Student") {
    ...
    $SubmissionArray = HunterSubmittedAnswersByCover($link, $loggedUser, $coverID, $prescriptionID, "Correct");
}
